...
%% ═══════════ 1. 加载数据 ═══════════
fprintf('=== 43075 LCO MF5.2 Fitting ===\n');
fprintf('Loading data...\n');
dataDir = '数据\Round8_mat';
SA_r=[]; FZ_r=[]; FY_r=[]; MZ_r=[]; IA_r=[]; P_r=[];
for rn=[18,19]
    load(fullfile(dataDir, sprintf('B1965run%d.mat', rn)));
...
title({'\bfHoosier 43075 LCO - Pacejka MF5.2 Model';...
...
saveas(gcf,'对比图\LCO_fig1_3D_model.png');
savefig(gcf,'对比图\LCO_fig1_3D_model.fig');
...
sgtitle({'\bfHoosier 43075 LCO - Camber Sensitivity @ 12 psi';...
    'Three camber curves nearly overlap \rightarrow camber-insensitive tire'},'FontSize',16);
saveas(gcf,'对比图\LCO_fig2_camber_insensitive.png');
savefig(gcf,'对比图\LCO_fig2_camber_insensitive.fig');
...
sgtitle('\bfHoosier 43075 LCO - Pressure Effect: 12 vs 10.5 psi','FontSize',16);
saveas(gcf,'对比图\LCO_fig3_pressure.png');
savefig(gcf,'对比图\LCO_fig3_pressure.fig');
